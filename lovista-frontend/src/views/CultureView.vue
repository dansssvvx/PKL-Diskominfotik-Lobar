  ...
  <div class="culture-view">
    ...
    <div class="container" style="padding-top: 100px; padding-bottom: 80px;">
      ...
      <div class="collection-banner">
        <div class="collection-banner__bg" style="background-image: url('https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&q=80&w=1200');"></div>
        <div class="collection-banner__content">
          <span class="collection-banner__label">- Collections</span>
          <h2 class="font-display">Culture & Heritage</h2>
          <p>Immerse yourself in local traditions and unforgettable cultural events.</p>
        </div>
      </div>

      <!-- Breadcrumbs & Title -->
      <div class="page-header mt-5">
        <div class="breadcrumb">Home &nbsp;•&nbsp; Culture & Heritage</div>
        <h1 class="page-title font-display">Culture & Heritage</h1>
      </div>
      ...
      <div class="shop-layout mt-4">
        ...
        <main class="shop-main">
          ...
          <div v-if="loading" class="page-loader" style="min-height: 400px; display:flex; flex-direction:column; align-items:center; justify-content:center;">
            ...
            <p style="margin-top: 16px; color: var(--w40);">Loading cultures...</p>
          </div>
          ...
          <div v-else>
            <div class="grid grid-3">
              <router-link :to="'/culture/' + item.id" class="product-card" v-for="item in items" :key="item.id">
                ...
                <div class="product-card__content">
                  ...
                  <p class="product-card__desc">{{ (item as any).village || (item as any).district || 'Local Heritage' }}</p>
                  
                  <div class="product-card__footer">
                    <div class="price-wrap">
                      <span class="price val text-success">Explore</span>
                    </div>
                    <div class="actions">
...
async function fetchData() {
  loading.value = true
  try {
    const { data } = await cultureApi.list(filters.value as any)
